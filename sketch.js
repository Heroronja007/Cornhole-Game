...
function setup(){
 ...
 /*boardOne = new Board1(1000, 500, {isStatic : true})
...
function draw(){
    ...
    if(bag1.body.position.y <= 500 && bag1.body.position.y >= 490){
        if(bag1.body.position.x <= 1130 && bag1.body.position.x >=880){
            score1 +=1
        }
    }
    if(bag1.body.position.y <= 500 && bag1.body.position.y >= 490){
        if(bag1.body.position.x <= 400 && bag1.body.position.x >= 50){
            score2 +=1
        }
    }

    if(bag1.body.position.y <= 510 && bag1.body.position.y >= 500){
        if(bag1.body.position.x <= 1150 && bag1.body.position.x >=1050){
            score1 +=2
        }
    }
    if(bag1.body.position.y <= 510 && bag1.body.position.y >= 500){
        if(bag1.body.position.x <= 100 && bag1.body.position.x >= 30){
            score2 +=2
        }
    }
    ...
    textSize(20)
    fill("black")
    text("Press SPACE to bring bag back", 500, 300)
